...
--
-- Хост: localhost
-- Время создания: Мар 21 2026 г., 10:06
...
INSERT INTO `reviews` (`id`, `description`, `user_id`, `order_id`) VALUES
(2, 'фвф', 3, 20),
(3, 'test', 3, 20),
(4, 'test2', 3, 20);
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id_orders`) ON DELETE CASCADE ON UPDATE CASCADE;
